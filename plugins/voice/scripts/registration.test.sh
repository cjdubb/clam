...
#       status cell exactly "✅ v0.1.2", final description, not the
...
# Retargeted v0.1.1 -> v0.1.2 by the README Update-section wave, in
...
check "voice row status cell is exactly '✅ v0.1.2'" "$STATUS_CELL" "✅ v0.1.2"
