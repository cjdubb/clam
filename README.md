...
| [statusline](plugins/statusline/) | ✅ v0.4.1 | Statusline: context usage, session/day/week cost, effort, tracking State. One explicit global write via `/statusline:setup`. |
