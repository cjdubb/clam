...
check "plugin.json version is exactly 0.18.0" "$b07_plugin_version" "0.18.0"
...
assert_contains_re_i "root README.md: tracking row's version cell is v0.18.0" "$tracking_row" \
    '✅ *v0\.18\.0'
