...
|--------|--------|--------------|
| [lego](plugins/lego/) | ✅ v0.15.1 | Contract-first planning, scaffolded stubs, realm-restricted test and implementation agent waves. Ported from clam-v2. |
...
| [build](plugins/build/) | ✅ v0.5.0 | High-level software build lifecycle framework: composites landing, lego, and tracking into a cohesive delivery lifecycle, providing delivery workflow context. |
