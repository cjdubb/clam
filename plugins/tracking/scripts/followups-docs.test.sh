...
check "plugin.json version is exactly 0.11.2" "$b07_plugin_version" "0.11.2"
...
assert_contains_re_i "root README.md: tracking row's version cell is v0.11.2" "$tracking_row" \
    '✅ *v0\.11\.2'
