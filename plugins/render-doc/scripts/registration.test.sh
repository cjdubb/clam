#!/bin/bash
# Test for Block B02 (registration). Authoritative contract: the HTML-comment
# docblock "Contract: B02 registration" in the root README.md, just under
# the Plugins table. Asserts directly on the two shared repo files the
