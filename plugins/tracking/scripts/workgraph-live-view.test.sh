...
check "B09 version: tracking plugin.json is exactly 0.18.0" "$plugin_version" "0.18.0"
...
assert_contains_re_i "B09 version: the root README.md tracking row's version cell is v0.18.0" \
    "$tracking_row" 'v0\.18\.0'
