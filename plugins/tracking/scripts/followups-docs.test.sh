...
check "plugin.json version is exactly 0.16.1" "$b07_plugin_version" "0.16.1"
...
assert_contains_re_i "root README.md: tracking row's version cell is v0.16.1" "$tracking_row" \
    '✅ *v0\.16\.1'
