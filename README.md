...
| [sleep-gate](plugins/sleep-gate/) | ✅ v0.1.0 | NotImplemented: B03 — stub row description, replaced at implementation with one naming the Bash tool and the completion-wait misuse. |
