...
check "B09 version: tracking plugin.json is exactly 0.16.0" "$plugin_version" "0.16.0"
...
assert_contains_re_i "B09 version: the root README.md tracking row's version cell is v0.16.0" \
    "$tracking_row" 'v0\.16\.0'
