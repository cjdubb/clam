 ...
 * Package: cytoscape-dagre@4.0.0 (npm), file dist/cytoscape-dagre.min.js (min build; bundles dagre internally and registers the 'dagre' layout when globalThis.cytoscape exists; peer cytoscape ^3.2.22)
 * License: MIT — https://github.com/cytoscape/cytoscape.js-dagre/blob/master/LICENSE
 * Provenance: byte-identical to the npm tarball; sha256(original) = b9e9d704119970f4255c035baa98d778e94af4b2efd2bdba20a601a869417223
 * To upgrade: replace this file with dist/cytoscape-dagre.min.js from the new npm tarball and update this header.
 */
/*!
