...
| [management](plugins/management/) | ✅ v0.3.0 | Guided plugin update flow: `/management:update` refreshes the clam catalog, diffs installed vs latest versions, and applies per-plugin updates on confirmation. |
