...
check "plugin.json version is exactly 0.19.0" "$b07_plugin_version" "0.19.0"
...
assert_contains_re_i "root README.md: tracking row's version cell is v0.19.0" "$tracking_row" \
    '✅ *v0\.19\.0'
