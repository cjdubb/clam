...
| [statusline](plugins/statusline/) | ✅ v0.4.3 | Statusline: context usage, session/day/week cost, effort, tracking State. One explicit global write via `/statusline:setup`. |
